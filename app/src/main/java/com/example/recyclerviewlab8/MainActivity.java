...
public class MainActivity extends AppCompatActivity {
    ...
    //vars
    private ArrayList<String> mNames = new ArrayList<>();      //specify images
    private ArrayList<String> mImageUrls = new ArrayList<>();  //specify image url
    ...
    private void initImageBitmaps() {
        ...
        initRecyclerView(); //populate data(images) into the list
